...
var websocketclient = {
    ...
    'connect': function () {
        ...
        this.subscribe('sensor', 0, $('#colorChooser').val().substring(1) )
        // if(websocketclient.subscribe($('#subscribeTopic').val(),parseInt($('#QoSInput').val()),$('#colorChooser').val().substring(1))){$.fancybox.close();}
    },
